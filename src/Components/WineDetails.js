                ...
                <div className="col-10 mx-auto text-center text-slanted text-blue my-5">
                  ...
                  <div className="row">
                    ...
                    <div className="col-10 mx-auto col-md-6 my-3 text-capitalize">
                      ...
                      <p className="text-muted lead mt-3">{info}</p>
                      <p className="text-muted lead mt-3">{acclaim}</p>
                      <p className="text-muted lead mt-3">{specs}</p>
                      <div className="">
                        <Link to="/">
                          <ButtonContainer1>Back To Product</ButtonContainer1>
                        </Link>
                        <ButtonContainer2
